...
3. Check out [these basic practice exercises](https://github.com/Momentum-Team-8/js-hello-world) for a warm-up. Clone that repo to work on the exercises locally. You do _not_ need to turn this in.
...
- [Code from class](https://github.com/Momentum-Team-8/example-js-first-day)
